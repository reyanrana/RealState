...
<body>
					  ...
					  ?>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    <div class="text-success text-left h5 my-2 text-md-right">Rs<?php echo $row['13'];?>
                                    </div>
    ...
    <script src="js/plugin/layerslider.kreaturamedia.jquery.js"></script>
   
    <script src="js/custom.js"></script>

    <script src="js/plugin/greensock.js"></script>
